...
// Wed Nov  7 17:23:27 2018 by ROOT version 6.12/07
// from TTree IIHEAnalysis/IIHEAnalysis
// found on file: outfile_544.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("outfile_544.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("outfile_544.root");
      }
