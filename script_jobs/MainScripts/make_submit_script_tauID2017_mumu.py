...
if __name__ == "__main__":
    ...
    code_name = "TauIDmeas2017_mumu"
    phase_name = "spurious"
    folder = "TauID2017/MuMu"
    ...
    for jj in range(0, len(pnfn)):    
        ...
        command1 = command1 + "cd /user/dbeghin/2nd/new/CMSSW_10_2_6/src " + "\n" #go to the top of your CMSSW release
        ...
        command3 = "qsub -q localgrid@cream02 -o " + "../out_err/"+myname[jj] +".stdout -e " +"../out_err/"+myname[jj] +".stderr -l walltime=20:00:00    " + "../Jobs_to_submit/"+name_out + "\n"  #Command to submit one job to the localgrid
        ...
        for i in f.readlines():   #f contains the root files in the /pnfs directory
            ...
            if ligne%files_per_job==0:   
                ...
                command1 = command1 + "cp /user/dbeghin/Work/POGTau/" + code_name + ".exe $scratchdir/" + "\n"
                outFile.write(command1)
                command3 = "qsub -q localgrid@cream02 -o "+ "../out_err/"+scr_name+".stdout -e " +"../out_err/"+scr_name +".stderr -l walltime=20:00:00    " + "../Jobs_to_submit/"+scr_name+ ".sh\n"
                submit_File.write(command3)
            ...
            command2 = command2 + "\n" + "./" + code_name + ".exe " + "Outout" +str(ligne)+myname[jj]+ ".root " +   bare_fname + " " + mynick[jj] + " " + phase_name + " " + myoption[jj]
            #command2 = command2 + " \n"+ "cp  Out" +str(ligne)+myname[jj]+ ".root \t" + "/user/dbeghin/Work/POGTau/"+folder+"/Out_"+myname[jj]+"/Out" +str(ligne)+myname[jj]+ ".root"
            command2 = command2 + "\n rm " + bare_fname
            command2 = command2 + " \n\n\n"
